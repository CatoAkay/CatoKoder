...
public class FemmerLagTest {
    ...
    public void femmerlagHarNavnOgSpillere() {
        ...
        FemmerLag lag = new FemmerLag("De gode hjelperne",
            new ArrayList<>(Arrays.asList(per, paal, espenAskeladd, gudbrand, smoerbukk)));
    ...
    public void femmerlagSkalHaAkkuratFemSpillere() {
        ...
        try {
            ...
            new FemmerLag("De gode hjelperne",
                new ArrayList<>(Arrays.asList(per, paal, espenAskeladd, gudbrand, smoerbukk, halvor)));
            fail("Skulle ha kastet exception");
        } catch (IllegalArgumentException e) {
            //Alt ok
        }
